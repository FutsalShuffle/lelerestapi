...
class ProductService
{
    ...
    public function getProduct()
    {
        ...
        $resultArr['product'] = $product;
        $resultArr['images'] = \Image::getImages($this->context->language->id, $id_product);
        ...
        if (\Combination::isFeatureActive()) {
            ...
            if ($combinations) {
                ...
                foreach ($combinations as $key => $row) {
                    ...
                    $combinations[$key]['price'] = \Product::getPriceStatic($row['id_product'], true, $row['id_product_attribute']);
                    $combinations[$key]['price_display'] = \Tools::displayPrice($combinations[$key]['price']);
                }
                $resultArr['combinations'] = $combinations;
            }
        };
        return $resultArr;
    }
