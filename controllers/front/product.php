...
class LelerestapiProductModuleFrontController extends RestController
{
    ...
    public function proccessGetMethod()
    {
        ...
        $this->response->setResult('product', Product::getProductProperties($this->context->language->id, $row));
        $this->response->setResult('images', Image::getImages($this->context->language->id, $this->id_product));
